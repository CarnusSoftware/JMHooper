...
// ________________________________________________________________ settings _______________________________________________________
    ...
    var color_degrading_mode = "single";     // can be "single" or "double"
    ...
    var base_color_red = 129;
    var base_color_green = 152;
    var base_color_blue = 71;
   
    var color_degrading_degree = -3;   // must be an integer
